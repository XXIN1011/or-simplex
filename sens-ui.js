...
(function () {
  ...
  function renderScenario() {
    var n = baseProb.c.length, m = baseProb.constraints.length;
  ...
  var TITLES = { c: '目标函数系数变化', b: '右端项变化', 'add-con': '增加一个约束', 'add-var': '增加一个变量' };
